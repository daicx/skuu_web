...
class TextFeildHomePageState extends State {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: <Widget>[
          ElevatedButton(child: Text("获取焦点"),onPressed: (){
            FocusScope.of(context).requestFocus(focusNode);
          },),
          ElevatedButton(child: Text("失去焦点"),onPressed: (){
            focusNode.unfocus();
          },),
          ElevatedButton(child: Text("编辑"),onPressed: (){
            setState(() {
              isEnable = true;
            });
          },),
          ElevatedButton(child: Text("不可编辑"),onPressed: (){
            setState(() {
              isEnable = false;
            });
          },),
